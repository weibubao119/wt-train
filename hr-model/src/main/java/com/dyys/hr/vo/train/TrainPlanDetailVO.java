...
@ApiModel(value = "培训计划详情VO")
public class TrainPlanDetailVO  implements Serializable {
    ...
    @ApiModelProperty(value = "反馈人员姓名")
    private String feedbackUserName;

    @ApiModelProperty(value = "需求类型常量id")
    ...
    private List<TrainPlanParticipantsVO> participantsList;
}
